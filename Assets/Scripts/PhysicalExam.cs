...
public class PhysicalExam : MonoBehaviour {
	...
	void Awake () {
		...
		// Respiratory
		physical ["Resp - Inspection"] = "No abnormalities";
		physical ["Resp - Palpation"] = "No abnormalities";
		physical ["Resp - Percussion"] = "No abnormalities";
		physical ["Resp - Auscultation"] = "Lungs are clear to auscultation bilaterally";
