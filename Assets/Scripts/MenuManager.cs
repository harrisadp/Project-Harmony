...
public class MenuManager : MonoBehaviour {
	...
	public void History () {
		...
		foreach (string i in menuOptions) {
			GameObject menuOption = Instantiate (playerMenuButtonPrefab, playerSelectionPanel.transform);
			menuOption.name = i;
		...
		GameObject backButton = Instantiate (backButtonPrefab, playerSelectionPanel.transform);
	...
	public void HPIPage1 () {
		...
		foreach (string i in menuOptions) {
			GameObject menuOption = Instantiate (playerSelectionButtonPrefab, playerSelectionPanel.transform);
			menuOption.name = i;
			menuOption.GetComponentInChildren<Text> ().text = i + "?";
			menuOption.transform.localScale = new Vector3 (1, 1, 1);
		}
		GameObject nextButton = Instantiate (backButtonPrefab, playerSelectionPanel.transform);
	...
	public void Labs () {
		...
		GameObject menuOption1 = Instantiate (playerMenuButtonPrefab, playerSelectionPanel.transform);
		...
		GameObject menuOption2 = Instantiate (playerSelectionButtonPrefab, playerSelectionPanel.transform);
